           ...
           stage('Distribute') {
                      steps {
                          script {
                              ...
                              sh "/usr/local/bin/firebase appdistribution:distribute app/build/outputs/apk/debug/app-debug.apk --app 1:484033308624:android:31abfd2405a664abf63bd5 --token '1//0gJWcjcxpMtf4CgYIARAAGBASNwF-L9IrI97kq0XIM3nUPh0nVL1lpn6zmLqbI53DIMsDoijMxgJePLJfkLebRQRQV_HWWqwPYo0'"
                          }
                      }
                  }
